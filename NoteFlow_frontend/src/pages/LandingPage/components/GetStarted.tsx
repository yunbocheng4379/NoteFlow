...
const OPTIONS = [
  { roman: 'I', title: '在线使用', subtitle: '推荐', body: '无需安装，注册账号后直接在网页里粘贴链接开始生成笔记。', code: null, link: { href: '/login', label: '前往登录', internal: true } },
  { roman: 'II', title: 'Docker Compose', subtitle: '自部署', body: '一条命令拉起完整 Web 栈，包含 MySQL、FastAPI 后端与前端。', code: 'docker compose up -d --build', link: null },
  { roman: 'III', title: '桌面客户端', subtitle: 'Windows / macOS', body: '打包好的桌面应用，双击安装即可使用，无需配置环境。', code: null, link: { href: GITHUB_URL, label: '联系获取安装包', internal: false } },
  { roman: 'IV', title: '浏览器插件', subtitle: 'Chrome / Edge', body: '在 chrome://extensions/ 加载解压后的扩展目录即可使用。', code: null, link: { href: GITHUB_URL, label: '联系获取安装说明', internal: false } },
]
